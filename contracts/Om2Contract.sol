...
import "@zk-kit/incremental-merkle-tree.sol/contracts/IncrementalBinaryTree.sol:IncrementalBinaryTree";

/// @title Semaphore
contract Om2 is ISemaphore, SemaphoreCore, SemaphoreGroups {
    //Events
    ...
    function createProposal(
        ...
        verifyProof(groupId, signal, nullifierHash, externalNullifier,proof);
        //2. Create Proposal
        proposalCounter++;
