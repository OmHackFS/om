...
export const DaoSettings = () => {
  ...
  async function createGroup(e: any) {
    ...
    const createGroupTx = await contract.createGroup(
      20,
      0,
      groupAdmin,
      canPropose,
  ...
  async function addMember() {
    ...
    const addMemberTx = await contract.addMember(
      addMemberGroupId,
      addMemberCommitmentId
    );
    ...
    const omABI = [
        ...
        inputs: [
          ...
          },
          {
            components: [
              ...
              { internalType: "string", name: "symmetricKey", type: "string" },
            ],
            indexed: false,
            internalType: "struct OmContract.dataStructure",
            name: "dataInfos",
            type: "tuple",
          },
        ],
      ...
      },
      {
        ...
        inputs: [
          ...
          },
          {
            ...
            indexed: false,
            internalType: "struct OmContract.Proposal",
            name: "proposalData",
            type: "tuple",
          },
        ],
      ...
      },
      {
        ...
        inputs: [
          ...
          { indexed: true, internalType: "bool", name: "vote", type: "bool" },
        ],
        name: "VoteCast",
        type: "event",
      },
      ...
      },
      {
        inputs: [
          ...
          {
            internalType: "uint256",
            name: "externalNullifierProposalId",
            type: "uint256",
          },
          { internalType: "bytes32", name: "signal", type: "bytes32" },
          { internalType: "uint256[8]", name: "proof", type: "uint256[8]" },
