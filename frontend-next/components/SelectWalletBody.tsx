      ...
      <div className="w-full h-16 flex justify-center items-center">
        {!active ? (
          <button
            onClick={handleClick}
            type="button"
            className="bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-5 text-center inline-flex items-center  mr-2 mb-2"
          >
            <svg
              aria-hidden="true"
        ...
        {active ? (
          <div className="flex flex-col">
            <div className="inline-flex justify-center rounded-md border border-transparent bg-green-100 text-sm font-medium text-green-900 hover:bg-green-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500 focus-visible:ring-offset-2 p-5">
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="inline-flex justify-center rounded-md border border-transparent text-sm font-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 p-5">
              Account: {account}
            </div>
          </div>
        ) : null}
